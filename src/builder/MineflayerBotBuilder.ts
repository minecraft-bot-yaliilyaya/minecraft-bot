...
export class MineflayerBotBuilder {
    ...
    createBot(): Bot {
        //TODO:: use MINEFLAYER_CONFIG
        return createBot({
            // host: MINEFLAYER_CONFIG.host,         // minecraft server ip
            // username: MINEFLAYER_CONFIG.username, // username to join as if auth is `offline`, else a unique identifier for this account. Switch if you want to change accounts
